...
var JobTitlesService = (function () {
    function JobTitlesService(httpClient, myGlobals) {
        this.httpClient = httpClient;
        this.myGlobals = myGlobals;
        this.jobTitleUrl = this.myGlobals.WebApiUrl + 'api/JobTitles';
    }
    JobTitlesService.prototype.getJobTitles = function () {
        return this.httpClient.get(this.jobTitleUrl)
            .toPromise().then(function (response) { return response.json(); }).catch(this.handleError);
    };
    JobTitlesService.prototype.handleError = function (error) {
        return Promise.reject(error.message || error);
    };
    JobTitlesService = __decorate([
        core_1.Injectable(), 
...
//# sourceMappingURL=job-title.service.js.map