...
export class PerformanceEvaluationDetailsComponent implements OnInit {
    constructor(
    ...
    ngOnInit() {
        this.route.params.forEach((params: Params) => {
            ...
            this.peService
                ...
                .catch((error) => this.myGlobals.showException(error, 'Error occured while trying to get evaluation. Details:', 'startPage'));
        });
    }
    ...
    exportToPdf(pe: PerformanceEvaluation) {
