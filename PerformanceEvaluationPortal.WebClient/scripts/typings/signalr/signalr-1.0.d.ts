...
interface INotificationClient {
    ...
    displayNotificationConsultant(notification: any): void;
}
interface INotificationServer {
   
    notifyConsultant(groupName: string, notification: any): void;
    joinGroup(groupName: string): any;
    leaveGroup(groupName: string): any;
